...
namespace Estudos_CSharp._3._Operações_de_Comparação
{
    internal class MaiorOuIgual
    {
        public static void executar()
        {
            ...
            Console.WriteLine("O operador de comparação maior ou igual que ( >= ) é utilizado para comparar dois valores e verificar se o primeiro é maior ou que o segundo número.\n");
